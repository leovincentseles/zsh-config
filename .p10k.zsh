# Generated by Powerlevel10k configuration wizard on 2020-10-09 at 16:14 CST.
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND=110
  ...
  #####################################[ vcs: git status ]######################################
  # disable the remote repository git icon
  ...
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND=222
  ...
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_ICON='✬'
  typeset -g POWERLEVEL9K_VCS_TAG_ICON='t'
  #  
  ...
  function my_git_formatter() {
	...
	meta='%0F'  # overwrite tag and commit foreground to black
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_BACKGROUND=222
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_BACKGROUND=222
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_PIPE_BACKGROUND=174
  ...
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_BACKGROUND=174
  # Default context color (no privileges, no SSH).
  typeset -g POWERLEVEL9K_CONTEXT_FOREGROUND=0
  typeset -g POWERLEVEL9K_CONTEXT_BACKGROUND=174
